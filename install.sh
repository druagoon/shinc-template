...
# @describe Install a binary release of shinc-template hosted on GitHub
...
# Project metadata
readonly NAME="shinc-template"
readonly URL="https://github.com/druagoon/shinc-template"
...
_argc_usage() {
    cat <<-'EOF'
Install a binary release of shinc-template hosted on GitHub
